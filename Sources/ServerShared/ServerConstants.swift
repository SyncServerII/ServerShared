...
public class ServerConstants {
    ...
    /// Used with some authorization systems, e.g., Dropbox and Solid.
    ...
    // HTTP: request header key
    // A refresh token is generated by some account systems on the client.
    public static let httpRequestRefreshToken = "X-refresh-token"
